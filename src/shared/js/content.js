      ...
      if (typeof html !== "undefined") {
        ...
        $html.find("a").each(function () {
          ...
          if (movieRegex.test(uri)) {
            ...
            $this.attr(
              "href",
              "https://letterboxd.com/search/" + encodeURIComponent(linkText)
            );
          }
        });
...
//   document
//     .querySelector("#tab-trivia > div.trivia-list.spoiler.spoiler-show")
//     .classList.add("spoiler-show");
// }
...
function insertTrivia(trivia) {
  ...
  var $newTab = $(
    '<li><a href="' + basePath + '" data-id="trivia">Trivia</a></li>'
  );
  ...
  for (var i = 0, l = trivia.length; i < l; i++) {
    ...
    if (trivia[i].title.startsWith("Spoiler")) {
      triviaHTML += `<span id="show-spoilers-span">This trivia may contain spoilers. 
      <a id="show-spoiler-trivia" href="javascript:void(0)" 
      onclick="(function(){
        document
          .querySelector('#tab-trivia > div.trivia-list.spoiler')
          .classList.add('spoiler-show');})();"
      class="spoiler-reveal">I can handle the truth.</a></span>`;
    }
  ...
  var $newTabContent = $(
    '<div id="tab-trivia" class="tabbed-content-block" style="display: none;">' +
      triviaHTML +
      "</div>"
  );
